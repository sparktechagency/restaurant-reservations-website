        ...
        <div className='py-2 bg-[#4b1c2f]'>
            <div className='container'>
                <div className='flex items-center justify-between'>
                    ...
                    {
                        showProfileCard &&
                        <div className='absolute z-[999] right-5 top-20 bg-white shadow-lg rounded-md p-4 w-48'>
                            <ul className='space-y-5'>
                                <li>
                                    <Link href={'/profile'} className='text-gray-700 hover:text-[#4b1c2f] flex items-center gap-2'><FaRegUserCircle /> My Profile</Link>
                                </li>
                                <li>
                                    <Link href={'/logout'} className=' text-[#e41f1f] flex items-center gap-2'><FiLogOut /> Logout</Link>
                                </li>
                            </ul>
                        </div>
                    }
