...
const Page = () => {
    return (
        <div className="max-w-4xl  px-4 py-10 font-sans">
            <h1 className="text-3xl font-bold text-[#360916] mb-8">My Bookmarks</h1>
            <div className="space-y-6">
                {reservations.map(({ id, name, rating, cuisine, location, description, image }) => (
                    <div
                        key={id}
                        className="flex relative border border-[#601a2e] rounded-lg overflow-hidden shadow-sm"
                    >
                        {/* Image */}
                        <img
                            src={image}
                        ...
                        <div className="p-4 flex flex-col justify-center flex-1">
                            ...
                            <span className='text-[#601a2e] absolute top-2 right-2'> <FaHeart /></span>
